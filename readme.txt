...
1. Для запуска приложения необходимо распаковать архив ex1.zip в папку, к которой имеет доступ Ваш WEB-сервера.
...
6. Форма обратной связи находится на вкладке Contact Us. Поля формы, помеченные * обязательны для заполнения. Файлы прикрепленые к форме загружаются на сервер в папку ./ex1/admin/heap. В базе данных хранятся только пути к этим файлам.
